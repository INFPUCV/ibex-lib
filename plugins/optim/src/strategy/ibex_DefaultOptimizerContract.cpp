//============================================================================
//                                  I B E X                                   
// File        : ibex_DefaultOptimizerContract.cpp
...
#include "ibex_DefaultOptimizerContract.h"
...
const double DefaultOptimizerContract::default_random_seed = 1.0;
...
NormalizedSystem& DefaultOptimizerContract::get_norm_sys(const System& sys, double eps_h) {
...
ExtendedSystem& DefaultOptimizerContract::get_ext_sys(const System& sys, double eps_h) {
...
DefaultOptimizerContract::DefaultOptimizerContract(const System& sys, double rel_eps_f, double abs_eps_f, double eps_h, bool rigor, bool inHC4, double random_seed, double eps_x, bool quiet) :
		OptimizerContract(sys.nb_var,
...
CtcCompo&  DefaultOptimizerContract::ctc(const System& ext_sys) {
