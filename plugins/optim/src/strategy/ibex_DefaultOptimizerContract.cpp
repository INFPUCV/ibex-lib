...
DefaultOptimizerContract::DefaultOptimizerContract(const System& sys, double rel_eps_f, double abs_eps_f, double eps_h, bool rigor, bool inHC4, double random_seed, double eps_x) :
