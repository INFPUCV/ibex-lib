...
#ifndef __IBEX_DEFAULT_OPTIMIZER_CONTRACT_H__
 ...
 */
class DefaultOptimizerContract : private Memory, public OptimizerContract {
public:
	/**
...
#endif // __IBEX_DEFAULT_OPTIMIZER_CONTRACT_H__
